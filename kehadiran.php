    ...
    <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                <form method="GET" action="kehadiran.php">
                                ...
                                <a href="index.php?page=kehadiran&aksi=tambah" class="btn btn-primary" > Input Kehadiran Data</a>
                                </form>
                                <br>
                                <?php 
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            $sql = $koneksi->query("SELECT * FROM gaji INNER JOIN pegawai ON gaji.nip=pegawai.nip INNER JOIN jabatan ON pegawai.kode_jabatan=jabatan.kode_jabatan WHERE gaji.bulan=$bulan AND gaji.tahun=$tahun");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="index.php?page=kehadiran&aksi=ubah&nip=<?php echo $data['nip']; ?>&bulan=<?php echo $data['bulan']; ?>&tahun=<?php echo $data['tahun']; ?>" class="btn btn-info"> Edit Data Kehadiran </a>
                                    </td>
                                </tr>
                            <?php }
                            if ($sql->num_rows > 0) {
