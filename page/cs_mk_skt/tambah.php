                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                                <input type="file" name="jaminan_keluarahan" class="form-control" placeholder="Lapirkan File" required />
                            </div>
                        </div>
...
if (isset($_POST['simpan'])) {
    ...
    $jaminan_keluarahan = $_FILES ['jaminan_keluarahan']['name'];
    $lokasi = $_FILES ['jaminan_keluarahan']['tmp_name'];
    $upload = move_uploaded_file($lokasi, "images/".$jaminan_keluarahan);

    $pbb = $_FILES ['pbb']['name'];
    $lokasi = $_FILES ['pbb']['tmp_name'];
    $upload = move_uploaded_file($lokasi, "images/".$pbb);

    $sql = $koneksi->query("INSERT INTO cs_intern (nomor,nama,suami,istri,permohonan,persetujuan,kk,nikah,keterangan,jaminan,jaminan_keluarahan,pbb)VALUES('$nomor','$nama','$suami','$istri','$permohonan','$persetujuan','$kk','$nikah','$keterangan','$jaminan','$jaminan_keluarahan','$pbb')");
