...
<hr>
   <h3><center><b>LAPORAN KEHADIRAN </b></center></h3> 
...
<table border="1" width="100%" style="border-collapse: collapse;">
   ...
   <th width="25px" height="50px">Masuk</th>
   <th width="25px" height="50px">Sakit</th>
   <th width="25px" height="50px">Izin</th>
   <th width="25px" height="50px">Alpha</th>
   <th width="25px" height="50px">Lembur</th>
 </tr>  
    </thead>
    <tbody>
        ...
        ?>
          <tr>
              ...
              <td width="100px" height="50px"><center><?php echo $data['masuk'];?> Hari</center></td>
              <td width="100px" height="50px"><center><?php echo $data['sakit'];?> Hari</center></td>
              <td width="100px" height="50px"><center><?php echo $data['izin'];?> Hari</center></td>
              <td width="100px" height="50px"><center><?php echo $data['alpha'];?> Hari</center></td>
              <td width="100px" height="50px"><center><?php echo $data['lembur'];?> Hari</center></td>                       
         </tr>  
        <?php }  ?>
            </tbody> 
            </table>
