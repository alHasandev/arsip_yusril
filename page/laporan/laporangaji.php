...
<table class="table table-borderless" style="width: 100%">
  <h3>
    <center><b>LAPORAN GAJI PEGAWAI </b></center>
  </h3>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td width="100px" height="50px">
          <center><?php echo $data['jumlah_anak']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['gaji_pokok']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['tunjangan']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['t_istrisuami']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['t_anak']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['uang_makan']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['uang_lembur']; ?> </center>
        </td>
        <td width="100px" height="50px">
          <center>RP.<?php echo $data['askes']; ?> </center>
        </td>
        <td width="100px" height="50px">
