...
<table border="1" width="100%" style="border-collapse: collapse;"> 
  ...
  <tbody>
        ...
        // pake ini di sql where bulan = '$bulan' AND tahun = '$tahun', di table tanpa bulan dan tahun
        
        $sql = $koneksi ->query("SELECT * from gaji INNER JOIN pegawai ON gaji.nip=pegawai.nip INNER JOIN jabatan ON pegawai.kode_jabatan=jabatan.kode_jabatan INNER JOIN golongan ON pegawai.kode_golongan = golongan.kode_golongan ");
